...
public class DashboardShellController {
	...
	public List<UrlInfo> getUrlInfos() {
		...
		UrlInfo elasticSearchUrl = new UrlInfo();
		elasticSearchUrl.setId(Utils.ELASTIC_SEARCH_URL);
		elasticSearchUrl.setUrl(env.getProperty(Utils.ELASTIC_SEARCH_URL, "#"));
		...
		urlsInfos.add(elasticSearchUrl);
	...
	@ResponseBody
	public UserInfo adminConsole() {
		UserInfo userInfo = new UserInfo("Authenticated");
		return userInfo;
	}
